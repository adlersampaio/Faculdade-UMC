...
public class FormAutonomo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTotVendas = new javax.swing.JLabel();
        ...
        lblTotVendas.setText("Total de vendas:");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblTotVendas, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(6, 6, 6)
                        .addComponent(txtTotVendas, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblPercentual, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(6, 6, 6)
                        .addComponent(txtPercentual, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        try {
            ...
            double a = Double.parseDouble(txtTotVendas.getText().trim().replace(",", "."));
            double b = Double.parseDouble(txtPercentual.getText().trim().replace(",", "."));

            aut = new Autonomo(nome, registro, a, b);
            txtSalario.setText(String.format("%.2f", aut.calculaSal()));
    ...
    private javax.swing.JLabel lblTotVendas;
